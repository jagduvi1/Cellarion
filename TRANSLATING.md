...
- `frontend/src/locales/translation.test.js` enforces structural integrity (key parity across languages, placeholder consistency, plural-family completeness, no empty strings) and runs in CI on every PR.
