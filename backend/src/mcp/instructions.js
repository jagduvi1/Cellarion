...
const INSTRUCTIONS = [
  ...
  '- A queue entry whose vintage the wine was never released in (a user typing a year the wine does not have) cannot be curated at all: use defer_vintage_maturity, never a guessed window. It leaves the pair uncurated and brings it back automatically if that vintage becomes real.',
