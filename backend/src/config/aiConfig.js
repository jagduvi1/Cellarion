...
- producerSuspect requires EVIDENCE, not unfamiliarity: set it only when you can NAME in producerNote what the value actually is (the house behind the brand line, the place or label term it duplicates). If you cannot say what it is instead, the most you may claim is producerUnknown. House-word constructions — "Vignoble X", "Cave de X", "Les Vignerons de X", "Weingut X", "Quinta do X" — are ordinary producer-name patterns and never by themselves grounds for suspicion.
