...
- producerUnknown: true when the Producer reads like a genuine winery name but you cannot place it, so this profile is really an appellation-level estimate. Most of the world's small estates fall here and that is NORMAL, not a defect in the record: set the flag, lower your confidence, and describe the wine from its grapes, region and type. Set producerUnknown, NOT producerSuspect, whenever your description would call the producer undocumented or unverifiable — the flags and the prose must agree.
