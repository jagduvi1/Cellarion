...
- The producerNote must never dress a guess as a finding (curator audit 2026-08-19: every note naming the actual entity was right, every "appears to be a negociant/private-label/generic brand" note was wrong). If you can name the specific other entity — the real house, the co-op, the non-winery body — name it. If you cannot, write "cannot verify this producer" and STOP: no negociant/private-label/generic/novelty speculation, no "appears to be" class guesses. A curator triaging at speed trusts specific-sounding language, so an unspecific claim in specific costume misleads exactly the people the note exists to help.
