...
const wineDraftsRoute = require('./routes/wineDrafts');
...
const adminBridgeRoute = require('./routes/admin/bridge');
...
const registryDataRoute = require('./routes/registryData');
const adminRegistryDataRoute = require('./routes/admin/registryData');
...
const forumLanguagesRoute = require('./routes/forumLanguages');
...
app.use('/api/wine-drafts', wineDraftsRoute);
...
app.use('/api/admin/bridge', adminBridgeRoute);
...
app.use('/api/registry-data', registryDataRoute);
app.use('/api/admin/registry-data', adminRegistryDataRoute);
...
app.use('/api/forum-languages', forumLanguagesRoute);
