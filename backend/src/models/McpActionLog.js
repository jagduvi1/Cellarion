...
const mcpActionLogSchema = new mongoose.Schema({
  ...
  action: { type: String, enum: ['pending', 'consume', 'restore', 'add', 'update', 'undo_add', 'bulk_preview', 'bulk_add', 'somm_maturity', 'somm_maturity_remove', 'somm_wine_profile', 'somm_price', 'somm_price_decline', 'cellar_create', 'rack_create', 'place', 'unplace', 'move', 'arrange_preview', 'arrange', 'tasting_note', 'attach_image', 'winelist_add', 'winelist_price', 'open', 'pour', 'close'], required: true },
